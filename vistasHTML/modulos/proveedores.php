      ...
      <div class="col-md-9">
        <div class="h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md">
          ...
          <form class="js-validate classocultar" novalidate="novalidate" id="formInfoCuentas" name="formInfoCuentas" method="post">
            ...
            <div class="row g-mb-20">
              <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md">
                <label class="mb-0">No. Cuenta</label>
              </div>
              ...
              <div class="col-md-9 align-self-center">
                <div class="form-group g-pos-rel mb-0 has-success">
                  ...
                  <input id="nocuenta" name="nocuenta" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12" type="text" data-error-class="u-has-error-v3" data-success-class="has-success" aria-required="false" aria-invalid="false">
                </div>
              </div>
            </div>
            ...
            <div class="row g-mb-20">
              <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md">
                <label class="mb-0">Clave Interbancaria:</label>
              </div>
              ...
              <div class="col-md-9 align-self-center">
                <div class="form-group g-pos-rel mb-0 has-success">
                  ...
                  <input id="clabeinter" name="clabeinter" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12" type="text" required="required" data-error-class="u-has-error-v3" data-success-class="has-success" aria-required="true" aria-invalid="false">
                </div>
              </div>
            </div>
            ...
            <div class="row g-mb-20">
              <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md">
                <label class="mb-0">Numero Convenio:</label>
              </div>
              ...
              <div class="col-md-9 align-self-center">
                <div class="form-group g-pos-rel mb-0 has-success">
                  ...
                  <input id="numconve" name="numconve" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12" type="text" required="required" data-error-class="u-has-error-v3" data-success-class="has-success" aria-required="true" aria-invalid="false">
                </div>
              </div>
            </div>
            ...
            <div class="row g-mb-20">
              ...
              <div class="col-md-9 align-self-center">
                <div class="form-group g-pos-rel mb-0 has-success">
                  ...
                  <input id="refer" name="refer" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12" type="text" required="required" data-error-class="u-has-error-v3" data-success-class="has-success" aria-required="true" aria-invalid="false">
                </div>
              </div>
            </div>
            ...
            <div class="row g-mb-20">
              <header>
                <h2 class="text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0">Cuentas Registradas</h2>
              </header>
            </div>
          ...
          <form class="js-validate classocultar" novalidate="novalidate" id="formInfoContactos" name="formInfoContactos" method="post">
            ...
            <div class="row g-mb-20">
              ...
              <div class="col-md-9 align-self-ceg-mb-10" type="submit">Guardar</button>
              <button class="btn btn-md btn-xl--md u-btn-outline-gray-dark-v6 g-font-size-12 g-font-size-default--md g-mr-10 g-mb-10" type="reset">Cancelar</button>
            </div>
          </form>
