		...
		<nav class="navbar no-gutters g-pa-0">
			...
			<form id="searchMenu" class="u-header--search col-sm g-py-12 g-ml-15--sm g-ml-20--md g-mr-10--sm" aria-labelledby="searchInvoker" action="#!">
				<div class="input-group g-max-width-450--sm">
					<input class="form-control h-100 form-control-md g-rounded-4 g-pr-40" type="text" placeholder="Enter Buscar Modulo">
				...
				<div class="col-auto d-flex g-pt-5 g-pt-0--sm g-pl-10 g-pl-20--sm">
					<div class="g-pos-rel g-px-10--lg">
						...
						<ul id="profileMenu" class="g-pos-abs g-left-0 g-width-100x--lg g-nowrap g-font-size-14 g-py-20 g-mt-17 rounded" aria-labelledby="profileMenuInvoker">
							<li class="g-mb-10">
								<a class="media g-color-primary--hover g-py-5 g-px-20" href="/minegocio/paneles/dashboards/perfil">
									<span class="d-flex align-self-center g-mr-12">
										<i class="hs-admin-user"></i>
									</span>
									<span class="media-body align-self-center" id="miPerfil">Mi Perfil</span>
								</a>
							</li>
							<li class="g-mb-10">
								<a class="media g-color-primary--hover g-py-5 g-px-20" href="#">
									...
									<span class="media-body align-self-center" id="nuevoNegocio">Nuevo Negocio</span>
								</a>
							</li>
							<li class="g-mb-10">
								<a class="media g-color-primary--hover g-py-5 g-px-20" href="#">
									...
									<span class="media-body align-self-center" id="abrirSucursal">Abrir Sucursal</span>
								</a>	
							</li>
							<li class="g-mb-10">
								<a class="media g-color-primary--hover g-py-5 g-px-20" href="#">
									...
									<span class="media-body align-self-center" id="soporteTec">Soporte</span>
								</a>
							</li>
							<li class="mb-0" id="cerrarSession">
								<a class="media g-color-primary--hover g-py-5 g-px-20">
									<span class="d-flex align-self-center g-mr-12">
										<i class="hs-admin-shift-right"></i>
									</span>
									<span class="media-body align-self-center">Cerrar Sesion</span>
								</a>
							</li>
						</ul>
						<!-- End Top User Menu -->
