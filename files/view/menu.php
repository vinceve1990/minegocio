        ...
        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg g-mr-40--lg" id="navBar">
          <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
            ...
            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
              <a href="/minegocio/inicio/inicio" class="nav-link g-py-7 g-px-0">INICIO</a>
            </li>
            <!-- End INICIO -->

            <!-- SOPORTE -->
            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
              <a href="../../unify-main/shortcodes/index.html" class="nav-link g-py-7 g-px-0">SOPORTE</a>
            </li>
            <!-- End SOPORTE -->

            <!-- CURSOS & AYUDAS -->
            <li class="nav-item  g-mx-10--lg g-mx-15--xl">
              <a href="../../unify-main/shortcodes/index.html" class="nav-link g-py-7 g-px-0">CURSOS & AYUDA</a>
            </li>
            <!-- End CURSOS & AYUDAS -->
          </ul>
        </div>
