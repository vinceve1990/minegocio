...
function style($bold = FALSE, $name = 'Calibri', $size = 10, $color = null, $horizontal = 'general', $vertical = 'bottom', $type = 'none', $startcolor = null, $endcolor = 'FF00FFFFFF', $code = 'General', $allborders = 'none', $wrap = FALSE) {
